...
void process_args(int argc, char *argv[], char **dirs,
			char **files, int *dir_count, int *file_count);
void print_dirs_and_files(char **dirs, char **files, int
				dir_count, int file_count);
